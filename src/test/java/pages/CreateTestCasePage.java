...
public class CreateTestCasePage {
    ...
    public CreateTestCasePage fillForm(TestCase testCase) {
        ...
        new Placeholder("pre-conditionGroup").write(testCase.getDescription());
        new Placeholder("post-conditionGroup").write(testCase.getDescription());
    ...
    public SelectedProjectPage clickSaveButton() {
        SAVE_BUTTON.click();
